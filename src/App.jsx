...
function App() {
  ...
  return <main className="app-shell">
    <header className="app-header"><div><p className="eyebrow">LESSON 05 / FRONTEND</p><h1>Việc cần làm<span>.</span></h1><p className="subtitle">Tổ chức ngày hôm nay, hoàn thành từng việc một.</p></div><button type="button" className="theme-button" onClick={() => setDarkMode((value) => !value)} aria-label={darkMode ? 'Bật chế độ sáng' : 'Bật chế độ tối'}>{darkMode ? '☼' : '☾'}</button></header>
